...
--Q1 Chemicals used most in Cosmetic and Personal Care Products
...
--Q2 Companies that used most reported chemicals in their cosmetic and personal care products (TOP 10)
...
--Q3 Brands that had chemicals that were removed and discontinued

--Changing Datatype for ChemicalDateRemoved from nvarchar to Datetime
Alter Table ['chemicals_in_cosmetics-$']
Alter Column ChemicalDateRemoved datetime

--Cleaning ChemicalDateRemoved Column (Changing 2103 to 2013)
Update ['chemicals_in_cosmetics-$']
...
Update ['chemicals_in_cosmetics-$']
Set ChemicalDateRemoved = '2014-02-05 00:00:00.000'
...
Select BrandName, ChemicalName, ChemicalDateRemoved
From ['chemicals_in_cosmetics-$']
Where ChemicalDateRemoved is Null and DiscontinuedDate is null
